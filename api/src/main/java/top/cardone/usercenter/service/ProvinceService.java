...
public interface ProvinceService extends PageService {
	...
	/**
     * @see ProvinceService#deleteByIds
     */
    @CacheEvict(allEntries = true)
    @Transactional
	...
	/**
     * @see ProvinceService#deleteList
     */
    @CacheEvict(allEntries = true)
    @Transactional
	...
	/**
     * @see ProvinceService#insertByNotExists
     */
    @CacheEvict(allEntries = true)
    @Transactional
	...
	/**
     * @see ProvinceService#insertList
     */
    @CacheEvict(allEntries = true)
    @Transactional
	...
	/**
     * @see ProvinceService#insertListByNotExists
     */
    @CacheEvict(allEntries = true)
    @Transactional
	...
	/**
     * @see ProvinceService#updateList
     */
    @CacheEvict(allEntries = true)
    @Transactional
