...
public class IndexFuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-usercenter/vx/usercenter/org/index.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/usercenter/org/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/usercenter/org/IndexFuncTest.func.output.json")
