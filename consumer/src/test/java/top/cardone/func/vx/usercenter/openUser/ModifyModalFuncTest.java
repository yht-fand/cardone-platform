...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/v1/usercenter/openUser/modifyModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/v1/usercenter/openUser/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/v1/usercenter/openUser/ModifyModalFuncTest.func.output.json")
