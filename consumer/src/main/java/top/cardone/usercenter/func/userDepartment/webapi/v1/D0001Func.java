 ...
 * 用户与部门 - 删除
 */
@Component("/web-api/v1/usercenter/userDepartment/d0001.json")
public class D0001Func implements Func1<Object, Map<String, Object>> {
    @Override
    public Object func(Map<String, Object> inputMap) {
        validate(inputMap);
		
        return ApplicationContextHolder.getBean(UserDepartmentService.class).deleteByIdsCache(inputMap);
    }
