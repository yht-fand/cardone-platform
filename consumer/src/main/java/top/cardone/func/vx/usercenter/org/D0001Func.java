 ...
 */
@Log4j2
@Component("/vx/usercenter/org/d0001.json")
public class D0001Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String orgIds = MapUtils.getString(inputMap, "orgIds");

        if (StringUtils.isBlank(orgIds)) {
            throw new CodeException("组织标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(OrgService.class).deleteByIdsCache(newInputMap);
    }
}