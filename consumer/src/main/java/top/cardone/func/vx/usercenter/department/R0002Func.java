 ...
 */
@Log4j2
@Component("/vx/usercenter/department/r0002.json")
public class R0002Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> departmentPage = ApplicationContextHolder.getBean(DepartmentService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(departmentPage.getContent(), outputTable);
