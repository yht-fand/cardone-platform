package top.cardone.func.vx.usercenter.city;
 ...
 */
@Log4j2
@Component("/vx/usercenter/city/r0003.json")
public class R0003Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> cityPage = ApplicationContextHolder.getBean(CityService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(cityPage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, cityPage.getTotalElements());
    }
}