 ...
 */
@Log4j2
@Component("/vx/usercenter/user/d0001.json")
public class D0001Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String userIds = MapUtils.getString(inputMap, "userIds");

        if (StringUtils.isBlank(userIds)) {
            throw new CodeException("用户标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(UserService.class).deleteByIdsCache(newInputMap);
    }
}