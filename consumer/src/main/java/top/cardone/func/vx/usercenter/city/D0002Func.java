 ...
 */
@Log4j2
@Component("/vx/usercenter/city/d0002.json")
public class D0002Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String cityIds = MapUtils.getString(inputMap, "cityIds");

        if (StringUtils.isBlank(cityIds)) {
            throw new CodeException("城市标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(CityService.class).deleteByIdsCache(newInputMap);
    }
}