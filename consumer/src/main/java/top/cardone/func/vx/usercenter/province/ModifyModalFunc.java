 ...
 */
@Log4j2
@Component("/vx/usercenter/province/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String provinceId = MapUtils.getString(inputMap, "provinceId");

        if (StringUtils.isBlank(provinceId)) {
            throw new CodeException("省份标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(ProvinceService.class).findOneByProvinceId(newInputMap);
