 ...
 */
@Log4j2
@Component("/vx/usercenter/region/d0003.json")
public class D0003Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String regionIds = MapUtils.getString(inputMap, "regionIds");

        if (StringUtils.isBlank(regionIds)) {
            throw new CodeException("区域标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(RegionService.class).deleteByIdsCache(newInputMap);
    }
}