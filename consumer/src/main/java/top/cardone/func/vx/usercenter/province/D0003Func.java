 ...
 */
@Log4j2
@Component("/vx/usercenter/province/d0003.json")
public class D0003Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String provinceIds = MapUtils.getString(inputMap, "provinceIds");

        if (StringUtils.isBlank(provinceIds)) {
            throw new CodeException("省份标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(ProvinceService.class).deleteByIdsCache(newInputMap);
    }
}