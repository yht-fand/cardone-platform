package top.cardone.func.vx.usercenter.user;
 ...
 */
@Log4j2
@Component("/vx/usercenter/user/r0002.json")
public class R0002Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> userPage = ApplicationContextHolder.getBean(UserService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(userPage.getContent(), outputTable);
