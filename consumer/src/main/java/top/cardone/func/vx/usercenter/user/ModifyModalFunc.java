 ...
 */
@Log4j2
@Component("/vx/usercenter/user/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(UserService.class).findOneByUserId(newInputMap);
