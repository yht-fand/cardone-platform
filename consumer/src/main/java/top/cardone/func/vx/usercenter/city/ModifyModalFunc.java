 ...
 */
@Log4j2
@Component("/vx/usercenter/city/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String cityId = MapUtils.getString(inputMap, "cityId");

        if (StringUtils.isBlank(cityId)) {
            throw new CodeException("城市标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(CityService.class).findOneByCityId(newInputMap);
