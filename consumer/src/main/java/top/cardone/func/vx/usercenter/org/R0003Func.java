 ...
 */
@Log4j2
@Component("/vx/usercenter/org/r0003.json")
public class R0003Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> orgPage = ApplicationContextHolder.getBean(OrgService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(orgPage.getContent(), outputTable);
