 ...
 */
@Log4j2
@Component("/vx/usercenter/userDepartment/c0001.json")
public class C0001Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(UserDepartmentService.class).insertByNotExistsCache(newInputMap);
    }
}