 ...
 */
@Log4j2
@Component("/vx/usercenter/openUser/r0001.json")
public class R0001Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> openUserPage = ApplicationContextHolder.getBean(OpenUserService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(openUserPage.getContent(), outputTable);
