package top.cardone.func.vx.usercenter.province;
 ...
 */
@Log4j2
@Component("/vx/usercenter/province/r0002.json")
public class R0002Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> provincePage = ApplicationContextHolder.getBean(ProvinceService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(provincePage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, provincePage.getTotalElements());
    }
}