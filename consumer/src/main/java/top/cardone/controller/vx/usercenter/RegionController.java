...
public class RegionController {
     ...
     **xx/
     ...
     return ApplicationContextHolder.getBean(WebSupport.class).func(request,
     (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RegionService.class).updateListCache((List) MapUtils.getObject(input, "regionIds")));
     }
     /** /d0001.json end **/
     ...
     **xx/
     ...
     return ApplicationContextHolder.getBean(WebSupport.class).func(request,
     (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RegionService.class).deleteListCache((List) MapUtils.getObject(input, "regionIds")));
     }
     /** /d0002.json end **/
     ...
     **xx/
     ...
     (Func1<Object, List<Map<String, Object>>>) inputList -> ApplicationContextHolder.getBean(RegionService.class).insertListByNotExistsCache(Lists.newArrayList(inputList)));
     }
     /** /m0004.json end **/
     ...
     **xx/
     ...
     readOne.put("regionCode", MapUtils.getString(input, "regionCode"));
     readOne.put("object_id", "regionId");

     String dbRegionId = ApplicationContextHolder.getBean(RegionService.class).readOne(String.class, readOne);

     if (dbRegionId != null) {
     String regionId = MapUtils.getString(input, "regionId");

     if (!StringUtils.equals(dbRegionId, regionId)) {
     throw new CodeException("regionCode already exists", "区域编号已经存在");
     }
     }

     return ApplicationContextHolder.getBean(RegionService.class).updateCache(input);
     });
     }
     /** /u0001.json end **/
