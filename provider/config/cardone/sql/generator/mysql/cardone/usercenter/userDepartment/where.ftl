...
<#if (where_and_eq_userDepartmentId_value??)>
${prefixName} `USER_DEPARTMENT_ID` = :where_and_eq_userDepartmentId_value
<#else>
${prefixName} `USER_DEPARTMENT_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_userDepartmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_userDepartmentId_value??)>
${prefixName} `USER_DEPARTMENT_ID` <> :where_and_nq_userDepartmentId_value
<#else>
${prefixName} `USER_DEPARTMENT_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_userDepartmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_userDepartmentId_value??)>
${prefixName} `USER_DEPARTMENT_ID` <> :where_and_like_userDepartmentId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_userDepartmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_userDepartmentId_value??)>
${prefixName} `USER_DEPARTMENT_ID` = :where_or_eq_userDepartmentId_value
<#else>
${prefixName} `USER_DEPARTMENT_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_userDepartmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_userDepartmentId_value??)>
${prefixName} `USER_DEPARTMENT_ID` <> :where_or_nq_userDepartmentId_value
<#else>
${prefixName} `USER_DEPARTMENT_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_userDepartmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_userDepartmentId_value??)>
${prefixName} `USER_DEPARTMENT_ID` like :where_or_like_userDepartmentId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
