...
<#if (where_and_nq_departmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_departmentId_value??)>
...
<#if (where_and_like_departmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_departmentId_value??)>
${prefixName} `DEPARTMENT_ID` <> :where_and_like_departmentId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_departmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_departmentId_value??)>
${prefixName} `DEPARTMENT_ID` = :where_or_eq_departmentId_value
<#else>
${prefixName} `DEPARTMENT_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_departmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_departmentId_value??)>
${prefixName} `DEPARTMENT_ID` <> :where_or_nq_departmentId_value
<#else>
${prefixName} `DEPARTMENT_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_departmentId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_departmentId_value??)>
${prefixName} `DEPARTMENT_ID` like :where_or_like_departmentId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
