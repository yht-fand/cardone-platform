...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM c1_user_address E
...
${prefixName} E.IS_DEFAULT = :where_and_eq_isDefault_value
<#else>
${prefixName} E.IS_DEFAULT IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
...
${prefixName} E.USER_ADDRESS_ID = :where_and_eq_userAddressId_value
<#else>
${prefixName} E.USER_ADDRESS_ID IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
