...
<#if (where_and_eq_openUserId??)>
<#if (where_and_eq_openUserId_value??)>
${prefixName} `OPEN_USER_ID` = :where_and_eq_openUserId_value
<#else>
${prefixName} `OPEN_USER_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_openUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_openUserId_value??)>
${prefixName} `OPEN_USER_ID` <> :where_and_nq_openUserId_value
<#else>
${prefixName} `OPEN_USER_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_openUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_openUserId_value??)>
${prefixName} `OPEN_USER_ID` <> :where_and_like_openUserId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_openUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_openUserId_value??)>
${prefixName} `OPEN_USER_ID` = :where_or_eq_openUserId_value
<#else>
${prefixName} `OPEN_USER_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_openUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_openUserId_value??)>
${prefixName} `OPEN_USER_ID` <> :where_or_nq_openUserId_value
<#else>
${prefixName} `OPEN_USER_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_openUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_openUserId_value??)>
${prefixName} `OPEN_USER_ID` like :where_or_like_openUserId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
