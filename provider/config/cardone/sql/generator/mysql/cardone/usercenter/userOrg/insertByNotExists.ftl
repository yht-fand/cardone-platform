...
<#if (insert_userOrgId??) && (insert_userOrgId_value??)>
${prefixName} :insert_userOrgId_value
<#assign prefixName = ','>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM c1_user_org E
...
${prefixName} E.USER_ORG_ID = :where_and_eq_userOrgId_value
<#else>
${prefixName} E.USER_ORG_ID IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
