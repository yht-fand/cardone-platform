...
<#if (insert_userOrgId??) && (insert_userOrgId_value??)>
${prefixName?string('  ', ', ')}"user_org_id"
<#assign prefixName = false>
</#if>
...
<#if (insert_userOrgId??) && (insert_userOrgId_value??)>
${prefixName?string('  ', ', ')}:insert_userOrgId_value
<#assign prefixName = false>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
WHERE NOT EXISTS (SELECT 1 FROM c1_user_org E
<#assign prefixName = true>
...
<#if (where_and_eq_userOrgId??)>
<#if (where_and_eq_userOrgId_value??)>
${prefixName?string('WHERE ', 'AND ')}E."user_org_id" = :where_and_eq_userOrgId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E."user_org_id" IS NULL OR E."user_org_id" = '')
</#if>
<#assign prefixName = false>
</#if>
