...
${prefixName?string('', ', ')}"c1__department_code" = :update_c1DepartmentCode_value
<#assign prefixName = false>
</#if>
...
${prefixName?string('', ', ')}"user_department_id" = :update_userDepartmentId_value
<#assign prefixName = false>
</#if>
<#if (update_userId??)>
