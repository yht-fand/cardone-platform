...
<#if (order_by_c1OrgCode??)>
${prefixName?string('ORDER BY ', ', ')}"c1__org_code" ${order_by_c1OrgCode_value!}
<#assign prefixName = false>
</#if>
...
<#if (order_by_userOrgId??)>
${prefixName?string('ORDER BY ', ', ')}"user_org_id" ${order_by_userOrgId_value!}
<#assign prefixName = false>
</#if>
<#if (order_by_version??)>
