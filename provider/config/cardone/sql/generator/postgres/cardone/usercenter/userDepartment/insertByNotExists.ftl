...
<#if (insert_userDepartmentId??) && (insert_userDepartmentId_value??)>
${prefixName} :insert_userDepartmentId_value
<#assign prefixName = ','>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
WHERE NOT EXISTS (SELECT 1 FROM c1_user_department E
...
${prefixName} E.user_department_id = :where_and_eq_userDepartmentId_value
<#else>
