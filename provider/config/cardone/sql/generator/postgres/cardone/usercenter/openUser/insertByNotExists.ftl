...
<#if (insert_openUserId??) && (insert_openUserId_value??)>
${prefixName?string('  ', ', ')}"open_user_id"
<#assign prefixName = false>
</#if>
...
<#if (insert_openUserId??) && (insert_openUserId_value??)>
${prefixName?string('  ', ', ')}:insert_openUserId_value
<#assign prefixName = false>
</#if>
<#if (insert_orderBy??) && (insert_orderBy_value??)>
...
WHERE NOT EXISTS (SELECT 1 FROM c1_open_user E
<#assign prefixName = true>
...
${prefixName?string('WHERE ', 'AND ')}E."open_user_id" = :where_and_eq_openUserId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E."open_user_id" IS NULL OR E."open_user_id" = '')
</#if>
<#assign prefixName = false>
</#if>
