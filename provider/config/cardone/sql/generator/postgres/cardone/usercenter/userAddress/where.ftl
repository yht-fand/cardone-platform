...
${prefixName} is_default = :where_and_eq_isDefault_value
<#else>
${prefixName} is_default IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
...
${prefixName} user_address_id = :where_and_eq_userAddressId_value
<#else>
${prefixName} user_address_id IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
