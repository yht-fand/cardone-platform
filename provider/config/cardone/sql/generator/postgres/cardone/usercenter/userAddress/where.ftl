...
${prefixName?string('WHERE ', 'AND ')}"is_default" = :where_and_eq_isDefault_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("is_default" IS NULL OR "is_default" = '')
</#if>
<#assign prefixName = false>
</#if>
...
${prefixName?string('WHERE ', 'AND ')}"region_id" = :where_and_eq_regionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("region_id" IS NULL OR "region_id" = '')
</#if>
<#assign prefixName = false>
</#if>
...
${prefixName?string('WHERE ', 'AND ')}"user_address_id" = :where_and_eq_userAddressId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("user_address_id" IS NULL OR "user_address_id" = '')
</#if>
<#assign prefixName = false>
</#if>
