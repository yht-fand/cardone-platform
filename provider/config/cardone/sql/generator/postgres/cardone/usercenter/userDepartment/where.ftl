...
${prefixName?string('WHERE ', 'AND ')}"user_department_id" = :where_and_eq_userDepartmentId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("user_department_id" IS NULL OR "user_department_id" = '')
</#if>
<#assign prefixName = false>
</#if>
