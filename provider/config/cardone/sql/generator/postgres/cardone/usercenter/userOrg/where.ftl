...
${prefixName?string('WHERE ', 'AND ')}"c1__org_code" = :where_and_eq_c1OrgCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("c1__org_code" IS NULL OR "c1__org_code" = '')
</#if>
<#assign prefixName = false>
</#if>
...
${prefixName?string('WHERE ', 'AND ')}"user_org_id" = :where_and_eq_userOrgId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("user_org_id" IS NULL OR "user_org_id" = '')
</#if>
<#assign prefixName = false>
</#if>
