...
${prefixName!''}AND (t.PARENT_CODE = :parentCode OR POSITION(:parentCode in t.PARENT_TREE_CODE))
    <#assign prefixName = ''>
<#elseif cardone.StringUtils.isNotBlank(parentTreeName)>
${prefixName!''}AND (POSITION(:parentTreeName in t.PARENT_CODE) OR POSITION(:parentTreeName in t.PARENT_TREE_CODE) OR POSITION(:parentTreeName in t.PARENT_TREE_NAME))
    <#assign prefixName = ''>
</#if>
...
${prefixName!''}AND (POSITION(:name in t.DEPARTMENT_CODE) OR POSITION(:name in t.NAME))
    <#assign prefixName = ''>
</#if>
