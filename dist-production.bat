...
xcopy provider\target\cardone-usercenter-provider-*.jar dist\production\provider /Y/C/R/I
...
xcopy consumer\target\cardone-usercenter-consumer-*.jar dist\production\consumer /Y/C/R/I
pause