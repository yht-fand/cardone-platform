...
xcopy provider\target\cardone-usercenter-provider-*.jar dist\demo\provider /Y/C/R/I
...
xcopy consumer\target\cardone-usercenter-consumer-*.jar dist\demo\consumer /Y/C/R/I
pause