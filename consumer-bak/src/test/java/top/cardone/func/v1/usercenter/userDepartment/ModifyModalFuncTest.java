package top.cardone.func.v1.usercenter.userDepartment;
...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/v1/usercenter/userDepartment/modifyModal.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/v1/usercenter/userDepartment/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/usercenter/userDepartment/ModifyModalFuncTest.func.output.json")
