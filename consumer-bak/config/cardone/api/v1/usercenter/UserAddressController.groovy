 ...
 */
@Controller
@RequestMapping("/v1/usercenter/userAddress")
class UserAddressController {
    ...
    Object c0001Json(HttpServletRequest request) {
        ApplicationContextHolder.getBean(WebSupport.class).func(request, { input -> ApplicationContextHolder.getBean(UserAddressService.class).insertByNotExistsCache(input) })
    }
    /** /c0001.json end **/
}