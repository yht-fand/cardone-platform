 ...
 */
@Controller
@RequestMapping("/v1/usercenter/city")
class CityController {
    ...
    Object c0001Json(HttpServletRequest request) {
        ApplicationContextHolder.getBean(WebSupport.class).func(request, { input -> ApplicationContextHolder.getBean(CityService.class).insertByNotExistsCache(input) })
    }
    /** /c0001.json end **/
}