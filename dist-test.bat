...
xcopy provider\target\cardone-usercenter-provider-*.jar dist\test\provider /Y/C/R/I
...
xcopy consumer\target\cardone-usercenter-consumer-*.jar dist\test\consumer /Y/C/R/I
pause